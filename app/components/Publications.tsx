            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  ...
                  >
                    <i className={`fa ${typeIcon[pub.type]}`} style={{ fontSize: "0.85rem" }} />
                    {typeLabel[pub.type]}
                  </span>
                  <span
                    style={{
                    ...
                    {pub.links.map((link, j) => (
                      <a
                        ...
                        onMouseLeave={(e) => {
                          ...
                          e.currentTarget.style.borderColor = "rgba(24,188,156,0.3)";
                        }}
                      >
                        <i className="fa fa-external-link" style={{ fontSize: "0.7rem" }} />
                        {link.label}
                      </a>
                    ))}
                  </div>
